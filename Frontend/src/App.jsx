...
const App = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-indigo-950 via-black to-purple-950 flex flex-col items-center justify-center py-4 sm:py-8 px-2 sm:px-4">
      <header className="w-full max-w-7xl flex flex-col sm:flex-row items-center justify-between mb-6 sm:mb-8 px-2 sm:px-4 gap-4 sm:gap-0">
        ...
        <span className="text-xs sm:text-sm text-gray-400 font-mono tracking-widest">by Dev</span>
      </header>
